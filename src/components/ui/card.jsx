...
function Card() {
  ...
  return (
    ...
    <div onClick={showModal}>
      <div className="flex flex-col justify-center items-center ml-5 sm:ml-0 mb-4 cursor-pointer">
            <div className="!z-5 relative flex flex-col rounded-[20px] max-w-[300px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 w-full !p-4 3xl:p-![18px] bg-white undefined">
                <div className="h-full w-full">
                    ...
                    <div className="mb-3 flex items-center justify-between px-1 md:items-start md:flex-col">
                        <div className="mb-2">
